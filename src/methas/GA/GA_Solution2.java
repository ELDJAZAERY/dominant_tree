...
public class GA_Solution2 extends Binary_Solution{
    ...
    public static GA_Solution2 crossOver(GA_Solution2 n1 , GA_Solution2 n2){
...
//        }
        ...
        GA_Solution2 nStar = new GA_Solution2();
    ...
    public GA_Solution2 LocalSearch(){
        GA_Solution2 sol ;

        for(int i = 1 ; i <= nbLocalSearch ; i++){
            sol = (GA_Solution2) this.clone();
